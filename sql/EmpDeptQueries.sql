...
SELECT DATEDIFF(YEAR,HIREDATE,CURRENT_TIMESTAMP) AS TENURE 
FROM EMP;
...
SELECT TOP(1) COUNT(DEPTNO) AS MAX_EMPLOYEE,DEPTNO 
FROM EMP GROUP BY DEPTNO ORDER BY COUNT(DEPTNO) DESC;
